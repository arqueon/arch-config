...
var_active_fg_color = '#282A36'
var_inactive_bg_color = '#333545'
var_inactive_fg_color = '#F8F8F2'
var_urgent_bg_color = '#FF5555'
var_urgent_fg_color = '#F8F8F2'
var_section_fg_color = '#F1FA8C'
var_active_color = '#bd93f9'
var_normal_color = '#333545'
var_border_width = 2
var_margin = [5,5,5,5]
var_gap_top = 5
var_gap_bottom = 43
