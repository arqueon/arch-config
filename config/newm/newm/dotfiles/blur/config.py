...
## General Settings ────────────────────────────────────────────────────────
corner_radius = 8		# Corner radius of workspace/desktop
...
def app_rules(view):
    ...
    blur_apps = ("Alacritty", "kitty", "foot", "rofi", "waybar", "mako")  # applications that should have the blur effect
...
## View ────────────────────────────────────────────────────────────────────
view = {
    'corner_radius': 8,			# Corner radius of View/Window/Container
